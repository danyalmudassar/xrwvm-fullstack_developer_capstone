...
# NOTE: This dynamic host was derived from your last error message.
# Use this exact host to fix the 403 CSRF error and the ALLOWED_HOSTS CommandError.
CORRECTED_HOST = 'dmudassar2-8000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai'

ALLOWED_HOSTS = ['localhost', '127.0.0.1', CORRECTED_HOST]

# Essential for resolving the CSRF 403 error in cloud environments/proxies
CSRF_TRUSTED_ORIGINS = [f'https://{CORRECTED_HOST}']
